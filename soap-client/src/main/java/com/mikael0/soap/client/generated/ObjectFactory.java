...
public class ObjectFactory {
    ...
    private final static QName _GetPersons_QNAME = new QName("http://standalone.soap.mikael0.com/", "getPersons");
    private final static QName _GetPersonsByParameters_QNAME = new QName("http://standalone.soap.mikael0.com/", "getPersonsByParameters");
    private final static QName _GetPersonsResponse_QNAME = new QName("http://standalone.soap.mikael0.com/", "getPersonsResponse");
    private final static QName _GetPersonsByParametersResponse_QNAME = new QName("http://standalone.soap.mikael0.com/", "getPersonsByParametersResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.soap.mikael0.com/", name = "getPersons")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.soap.mikael0.com/", name = "getPersonsByParameters")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.soap.mikael0.com/", name = "getPersonsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.soap.mikael0.com/", name = "getPersonsByParametersResponse")
