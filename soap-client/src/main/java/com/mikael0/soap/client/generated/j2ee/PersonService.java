 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://j2ee.mikael0.com/", wsdlLocation = "http://localhost:8163/PersonService/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://j2ee.mikael0.com/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8163/PersonService/PersonService?wsdl");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://j2ee.mikael0.com/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://j2ee.mikael0.com/", "PersonWebServicePort"), PersonWebService.class, features);
    }
