 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://standaloneerror.soap.mikael0.com/", wsdlLocation = "http://localhost:8080/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://standaloneerror.soap.mikael0.com/", "PersonService");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://standaloneerror.soap.mikael0.com/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://standaloneerror.soap.mikael0.com/", "PersonWebServicePort"), PersonWebService.class, features);
    }
